...
from model_v0 import ModelBackend
...
class Win32Svc (win32serviceutil.ServiceFramework):
    _svc_name_ = "LabelStudioBackend"
    _svc_display_name_ = "LabelStudio Backend Service"
    ...
    def main(self):
            ...
            "handlers": {
                "console": {
                 ...
                 "file": {
                    ...
                    "filename": os.path.join(workspace, "backend.log"),
        ...
        if args.check:
            print('Check "' + ModelBackend.__name__ + '" instance creation..')
            model = ModelBackend(**kwargs)
